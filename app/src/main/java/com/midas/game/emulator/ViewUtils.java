...
public class ViewUtils {
    ...
    public static ViewPort computeViewPort(IEmulator emulator, int screenWidth,
    ...
    public static ViewPort loadOrComputeViewPort(Context context, IEmulator emulator,
